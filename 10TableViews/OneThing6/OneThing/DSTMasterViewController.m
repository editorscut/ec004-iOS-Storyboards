...
- (void)viewDidLoad {
    ...
    self.detailViewController = (DSTDetailViewController *)[[self.splitViewController.viewControllers lastObject] topViewController];
}
...
- (IBAction)insertNewEvent:(UIStoryboardSegue *)segue {
    ...
    DSTEvent *event = [NSEntityDescription insertNewObjectForEntityForName:[entity name]
                                                    inManagedObjectContext:context];
    event.title = inputVC.title;
    event.eventDescription = inputVC.eventDescription;
...
- (IBAction)cancelInsertNewEvent:(UIStoryboardSegue *)segue {}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"DSTEvent" inManagedObjectContext:self.managedObjectContext];
